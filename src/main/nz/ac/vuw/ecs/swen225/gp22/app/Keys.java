...
public class Keys implements KeyListener {
	private final Map<Integer, Runnable> actionsPressed = new HashMap<>(); //map for actions on pressed
	private final Map<Integer, Runnable> actionsCtrlReleased = new HashMap<>(); //maps for actions on ctrl release
	private final Map<Integer, Runnable> actionsReleased = new HashMap<>(); //map for actions on release
