...
public class MenuMainPanel extends JPanel {
	...
	private final Dimension buttonGap = new Dimension(10, 10); //gap between buttons
	private final Dimension halfButtonSize = new Dimension(110, 30); //size of half buttons
